  ...
  return (
    <div className='container-about'>
      <div className="container-about-interno">
        ...
        <div className='about'>
          <h2><span>¿</span>Que encontraras en el sitio<span>?</span></h2>
          <p>En la pagina podras encontrar documentacion sobre diversas tecnologias de desarrollo y recursos css que te resultaran de utilidad al momento de desarrollar tus paginas web</p>
        </div>
      </div>
    </div>
  )
